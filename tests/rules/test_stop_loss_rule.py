...
class TestStopLossRule(unittest.TestCase):
    ...
    def test_is_satisfied_for_buy(self):
        ...
        trading_record.enter(2, Decimal('114'), self.traded_amount)
        ...
        trading_record.enter(5, Decimal('128'), self.traded_amount)
    ...
    def test_is_satisfied_for_sell(self):
        ...
        trading_record.enter(1, Decimal('108'), self.traded_amount)
